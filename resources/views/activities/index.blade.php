...
<body>
                    ...
                    <div class="main-content">
                        <div class="header">
                            ...
                            <div class="header-controls">
                                <div class="date">
                                    <input type="date" id="currentDate" class="form-control d-inline-block"
                                        style="width: 160px;" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="eventForm" method="POST" action="{{ route('activitiesStore') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="eventTitle" name="title"
                                value="{{ old('eventTitle') }}" placeholder="Nhập tiêu đề sự kiện">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="eventType" name="category_id">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="eventNote" rows="3" placeholder="Thêm ghi chú..." name="description"></textarea>
                        </div>

                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="isRecurring" name="repeat">
    ...
    <script>
        window.activities = @json($activities);
    </script>
</body>
